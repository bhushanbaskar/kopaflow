  ...
  return (
    <div className="space-y-3.5 max-w-5xl mx-auto pb-4">
      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-[22px] border border-black/[0.06] shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
        ...
        <a
          href="/matching"
          className="w-full sm:w-auto py-2.5 px-4 bg-emerald-700 hover:bg-emerald-800 text-white rounded-full text-xs font-mono font-bold flex items-center justify-center gap-1.5 touch-press shadow-sm"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        <div className="bg-white p-3 rounded-2xl border border-black/[0.06] shadow-xs">
          <div className="text-[9px] font-mono text-gray-500 uppercase font-semibold">Active Total</div>
          <div className="text-base font-bold font-mono text-gray-950 mt-0.5">{MOCK_AGRI_SHIPMENTS.length} Shipments</div>
        </div>
        <div className="app-card-peach p-3 rounded-2xl shadow-xs">
          <div className="text-[9px] font-mono text-amber-900 uppercase font-semibold">Pending Match</div>
          <div className="text-base font-bold font-mono text-amber-950 mt-0.5">3 Pending</div>
        </div>
        <div className="app-card-green p-3 rounded-2xl shadow-xs">
          <div className="text-[9px] font-mono text-emerald-900 uppercase font-semibold">Matched to Bus</div>
          <div className="text-base font-bold font-mono text-emerald-950 mt-0.5">2 Matched</div>
        </div>
        <div className="app-card-blue p-3 rounded-2xl shadow-xs">
          <div className="text-[9px] font-mono text-blue-900 uppercase font-semibold">In Transit</div>
          <div className="text-base font-bold font-mono text-blue-950 mt-0.5">2 In Transit</div>
        </div>
      </div>
      ...
      <div className="space-y-2.5">
        {filteredShipments.map((s) => (
          <div
            ...
            className="app-card rounded-[22px] p-3.5 sm:p-4 hover:border-black/[0.12] cursor-pointer touch-press transition-all space-y-2.5"
          >
            {/* Top Row: Code, Commodity, Weight & Status */}
            <div className="flex items-start justify-between gap-2">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 rounded-full bg-emerald-600 text-white flex items-center justify-center text-base shadow-xs shrink-0">
                  🌾
                </div>
                <div>
            ...
            <div className="p-2.5 bg-gray-50/80 rounded-2xl border border-black/[0.04] flex items-center justify-between text-xs font-mono">
              <div>
