  ...
  () => import("../../../components/map/KopargaonMap"),
  {
    ...
    loading: () => (
      <div className="w-full h-full min-h-[500px] bg-gray-100 rounded-[5px] border border-black/[0.07] flex flex-col items-center justify-center text-gray-400 font-mono text-xs">
        ...
        <span>LOADING KOPARGAON SPATIAL ROAD NETWORK...</span>
      </div>
    ),
  }
);
...
export default function FullscreenMapPage() {
  return (
    <div className="space-y-3 h-[calc(100vh-85px)] lg:h-[calc(100vh-95px)] flex flex-col">
      {/* Top Header Bar */}
      <div className="bg-white px-3.5 sm:px-4 py-2.5 rounded-[22px] border border-black/[0.06] shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 shrink-0">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-8 h-8 rounded-full bg-gray-950 text-white flex items-center justify-center shrink-0 shadow-xs">
      ...
      <div className="flex-1 w-full bg-white rounded-[24px] border border-black/[0.06] overflow-hidden shadow-xs relative">
